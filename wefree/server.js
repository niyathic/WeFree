...
var app = express();
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:3000/wefree') //mongoose connect call
...
//     return;
// })
//make sure any route not handled above is handled by the react router
app.get('*', (req, res) => {                       
